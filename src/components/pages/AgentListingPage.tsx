...
const allAgents: Agent[] = [
  ...
  },
  {
    ...
    sampleOutput: 'Based on current market conditions, competitor pricing at Rs89.99, and your inventory levels, the optimal price for this product is $79.99 - projected to increase sales by 23% while maintaining healthy margins.',
  ...
  },
  {
    ...
    sampleOutput: 'Q4 Forecast: Projected 34% increase in sales during Black Friday week. Recommend increasing inventory for top 10 products by 45%. Expected revenue impact: +Rs1125K based on historical data.',
