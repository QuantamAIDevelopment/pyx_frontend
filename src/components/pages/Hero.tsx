    ...
    Your browser does not support the video tag.
      ...
      <div className="relative container mx-auto px-4 sm:px-6 lg:px-8 w-full z-20">
        <div className="text-center max-w-5xl mx-auto">
          ...
          <div className="inline-flex items-center space-x-2 bg-[#FF620A]  dark:from-blue-600/30 dark:to-purple-600/30 backdrop-blur-md px-6 py-3 rounded-full mb-8 border border-blue-200/80 dark:border-blue-400/40 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105">
          ...
          <h1 className="text-12xl sm:text-5xl lg:text-6xl xl:text-7xl font-quncry font-bold tracking-tight mb-8 leading-tight">
            <span className="block mb-3 text-white dark:text-white drop-shadow-lg">SHAPE YOUR</span>
            <span className="block !bg-white bg-clip-text text-[#FF620A] dark:text-orange-400 mb-3 drop-shadow-2xl" style={{ backgroundSize: '200% 100%' }}>
              AI ECOSYSTEM
            </span>
            <span className="block text-white dark:text-white drop-shadow-lg">FOR THE FUTURE</span>
          </h1>

          {/* Enhanced subtitle with superior contrast against vibrant background - Light/Dark Mode */}
          <p className="text-xl sm:text-2xl text-white dark:text-gray-50 max-w-3xl mx-auto mb-12 leading-relaxed drop-shadow-lg font-medium ">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center mb-20 ">
            <Button 
              ...
              size="lg" 
              className=" !bg-[#FF620A] text-white px-12 py-7 text-lg font-semibold rounded-2xl transition-all duration-500 shadow-2xl hover:shadow-3xl transform hover:scale-110 border-0 relative overflow-hidden border-none"
            >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 lg:gap-12 max-w-5xl mx-auto">
            <div className="text-center group cursor-pointer">
              <div className="relative flex items-center justify-center w-24 h-24 mx-auto mb-8 bg-transparent border-2 border-orange-400 rounded-3xl shadow-2xl group-hover:scale-125 group-hover:rotate-6 transition-all duration-500 group-hover:shadow-transparent  backdrop-blur-sm overflow-hidden">
                {/* Animated background */}
              ...
              <div className="text-lg text-white dark:text-gray-300 font-semibold drop-shadow-sm group-hover:text-orange-400 dark:group-hover:text-blue-400 transition-colors duration-300">
                Specialized AI Agents
              </div>
            </div>
            
            <div className="text-center group cursor-pointer">
              <div className="relative flex items-center justify-center w-24 h-24 mx-auto mb-8 bg-transparent  border-2 border-orange-400 rounded-3xl shadow-2xl group-hover:scale-125 group-hover:-rotate-6 transition-all duration-500 group-hover:shadow-purple-500/50 backdrop-blur-sm overflow-hidden">
              ...
              <div className="text-lg text-white dark:text-gray-300 font-semibold drop-shadow-sm group-hover:text-orange-400 transition-colors duration-300">
                Average Efficiency Boost
              </div>
            </div>
            
            <div className="text-center group cursor-pointer">
              <div className="relative flex items-center justify-center w-24 h-24 mx-auto mb-8 bg-transparent border-2 border-orange-400 rounded-3xl shadow-2xl group-hover:scale-125 group-hover:rotate-12 transition-all duration-500 group-hover:shadow-pink-500/50 backdrop-blur-sm overflow-hidden">
                <div className="absolute inset-0 bg-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
              ...
              <div className="text-lg text-white dark:text-gray-300 font-semibold drop-shadow-sm group-hover:text-orange-400 dark:group-hover:text-pink-400 transition-colors duration-300">
