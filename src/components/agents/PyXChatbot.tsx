      ...
      <div className="fixed bottom-6 right-6 z-50">
        <div className="relative group">
          <Button
            ...
            className="h-14 w-14 rounded-full bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 hover:from-blue-400 hover:via-purple-400 hover:to-pink-400 shadow-2xl hover:shadow-blue-500/25 transition-all duration-300 hover:scale-110 relative overflow-hidden border-0"
          >
          ...
          <div className="p-4 border-t bg-gray-50/50 dark:bg-gray-800/50">
            <div className="flex items-end space-x-2">
              ...
              <Button
                ...
                className="h-9 w-9 p-0 bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-400 hover:to-purple-400 text-white"
              >
